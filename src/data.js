/**
 * ข้อมูลตั้งต้นของเว็บไซต์ หลังติดตั้งแก้และบันทึกผ่านแอดมินลง D1
...
/** ฟอร์มส่งเข้า D1 ผ่าน Worker; เปิด/ปิดในแอดมิน ไม่มี external API key */
export const FORM = {
  enabled: true,
  accessKey: '',
...
export const I18N = {
  th: {
    ...
    knowledge: {
      ...
      uses: [
        { image: 'work-04', alt: 'เติมน้ำเข้าแท็งก์หน้าห้องแถว', title: 'อุปโภคในบ้านและร้านค้า', text: 'ประกอบอาหาร ชำระล้างร่างกาย ซักผ้า ล้างจาน ทำความสะอาด และงานบ้านแทบทุกอย่างในชีวิตประจำวัน' },
      ...
      benefits: [
        ...
        { title: 'น้ำสำหรับดื่มต้องต้มหรือกรองก่อน', text: 'น้ำประปาเป็นต้นทางของน้ำดื่มในหลายบ้าน แต่น้ำที่พักในแท็งก์หรือขนส่งมาทางรถอาจมีตะกอนปน ก่อนนำไปดื่มหรือประกอบอาหารจึงควรต้มหรือผ่านเครื่องกรองทุกครั้ง น้ำที่ธารนทีจัดส่งเป็นน้ำประปาสำหรับงานอุปโภค ไม่ได้จำหน่ายเป็นน้ำดื่ม' },
  ...
  en: {
    ...
    knowledge: {
      ...
      uses: [
        { image: 'work-04', alt: 'Filling storage tanks in front of a shophouse', title: 'Homes and shops', text: 'Cooking, washing, laundry, dishes, cleaning, and almost every other daily task at home and in the shop.' },
      ...
      benefits: [
        ...
        { title: 'Boil or filter before drinking', text: 'Tap water is where drinking water starts for many homes, but water stored in a tank or carried by truck can pick up sediment. Always boil or filter it before drinking or cooking. The tap water Natee delivers is for non-drinking uses and is not sold as drinking water.' },
