...
function natee_ui_strings() {
	return array(
		...
		'lightbox_label'   => array( 'ตัวดูรูปผลงาน', 'Photo viewer' ),
		'lightbox_close'   => array( 'ปิด', 'Close' ),
		'lightbox_prev'    => array( 'รูปก่อนหน้า', 'Previous photo' ),
		'lightbox_next'    => array( 'รูปถัดไป', 'Next photo' ),
		'lightbox_of'      => array( 'จาก', 'of' ),
		'lightbox_hint'    => array( 'ปัดซ้ายขวาเพื่อดูรูปอื่น', 'Swipe left or right to see more photos' ),
