...
<section class="natee-hero" id="natee-hero">
	<div class="natee-container natee-hero-inner">
		<div class="natee-hero-text">
			<?php if ( natee_opt( 'hero_eyebrow', '' ) ) : ?>
				<p class="natee-eyebrow"><?php echo esc_html( natee_opt( 'hero_eyebrow', '' ) ); ?></p>
			<?php endif; ?>

			<h1 class="natee-hero-title"><?php echo esc_html( natee_opt( 'hero_title', '' ) ); ?></h1>

			<?php if ( natee_opt( 'hero_subtitle', '' ) ) : ?>
				<p class="natee-hero-subtitle"><?php echo esc_html( natee_opt( 'hero_subtitle', '' ) ); ?></p>
			<?php endif; ?>
			...
			<?php if ( natee_opt( 'hero_note', '' ) ) : ?>
				<p class="natee-hero-note">
					...
					<span><?php echo esc_html( natee_opt( 'hero_note', '' ) ); ?></span>
				</p>
			<?php endif; ?>
		</div>
		...
		$hero_tag     = natee_media_tag( $hero_image, $hero_bundled['hero'], 'large', 'natee-hero-image', natee_opt( 'hero_title', '' ) );
		?>
